...
<div class="container">
    <div class="row justify-content-center py-4">
        ...
        <div class="col-md-6">
            <!-- <img class="register" src="/storage/images/banner4.jpg" alt=""> -->
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="background-color: #1e2537; font-weight: 700; color: #fff;">{{ __('CREATE AN ACCOUNT') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="first_name" class="col-md-4 col-form-label"><strong>{{ __('First Name') }}</strong></label>
                        ...
                        <div class="form-group row">
                            <label for="last_name" class="col-md-4 col-form-label"><strong>{{ __('Last Name') }}</strong></label>
